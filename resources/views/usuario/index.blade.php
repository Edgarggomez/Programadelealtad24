          ...
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <td>
                ...
                <a class="btn btn-primary" href="{{ route('usuarios.edit',$user->id) }}"><svg class="bi bi-pencil-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
